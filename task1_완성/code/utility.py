...
def make_question():
    ...
    '''
    Q1 = ["힘든 상황을 마주했을 때, 어떻게 대처하는 편인가요? 문제를 분석하고 이를 해결하기 위한 계획을 세우는 편인가요, 아니면 감정을 표현하고 지원을 받는 편인가요?", "갈등 상황을 다룰 때, 직면하여 해결하는 편이세요 아니면 갈등을 피하는 편이세요?", "새로운 정보를 받았을 때, 이를 어떻게 처리하는지 설명해 주실 수 있나요?", "일반적으로 당신은 어떤 방식으로 생각하나요? 현실적이고 구체적인 방식으로, 아니면 추상적이고 이론적인 방식으로인가요?", "책상 위에 무엇이 가장 많이 보이나요?", "새로운 사람을 친구로 만들 때, 당신이 가장 중요하게 생각하는 특성은 무엇인가요?"]
    Q2 = ["당신은 새로운 장소에 가면 무엇을 먼저 하나요?", "가장 좋아하는 취미는 무엇인가요?", "휴일을 보내는 방식에 대해 어떻게 생각하나요?", "새로운 사람들을 만나는 것이 어떤 감정을 느끼게 하나요? 흥분, 두려움, 혹은 모호함 등?", "프로젝트를 진행할 때, 혼자서 작업하는 것을 선호하시나요 아니면 다른 사람과 협업하는 것을 좋아하시나요?", "어떤 종류의 사람들과 시간을 보내는 것을 가장 선호하나요? (에너제틱한 사람, 창의적인 사람, 조용한 사람 등)"]
    Q3 = ["새로운 기술이나 앱을 배우거나 시도할 때, 당신의 반응은 어떤가요?", "생각할 때나 문제를 해결할 때 당신의 접근 방식은 무엇인가요?", "어떤 종류의 음악을 가장 좋아하나요? 그 이유는 무엇인가요?", "당신이 책을 읽을 때, 주로 무슨 장르의 책을 선택하시나요?", "당신이 새로운 정보를 받았을 때, 이를 어떻게 처리하는지 설명해 주실 수 있나요?", "일반적으로 당신은 어떤 방식으로 생각하나요? 현실적이고 구체적인 방식으로, 아니면 추상적이고 이론적인 방식으로인가요?", "자주 꾸는 꿈이 있나요? 그 꿈을 설명해 주세요."]
    Q4 = ["당신이 일을 처리하는 방식은 어떠한가요? 세부적인 계획을 세우는 편인가요, 아니면 유연하게 흘러가는 대로 하는 편인가요?", "당신이 의사결정을 내리는 데에 가장 중요하게 생각하는 것은 무엇인가요? 객관적인 사실과 데이터인가요, 아니면 주관적인 감정과 가치인가요?", "어떤 사람을 친구로 만들 때, 당신이 가장 중요하게 생각하는 특성은 무엇인가요?", "힘든 상황을 마주했을 때, 어떻게 대처하는 편인가요? 문제를 분석하고 이를 해결하기 위한 계획을 세우는 편인가요, 아니면 감정을 표현하고 지원을 받는 편인가요?"]
    Q5 = ["당신은 어떤 상황에서 가장 편안하게 느껴지나요? 이미 알고 있는 상황에서, 아니면 새로운 상황과 경험에서인가요?", "갈등 상황을 다룰 때, 직면하여 해결하는 편이세요 아니면 갈등을 피하는 편이세요?", "당신이 새로운 프로젝트를 시작할 때, 어떻게 진행하는 편인가요? 계획을 세우고 체계적으로 진행하는가, 아니면 즉흥적으로 시작하나요?", "여행을 계획할 때, 상세한 일정표를 선호하시나요 아니면 즉흥적인 계획을 좋아하시나요?", "당신이 새로운 프로젝트를 시작할 때, 어떻게 진행하는 편인가요? 계획을 세우고 체계적으로 진행하는가, 아니면 즉흥적으로 시작하나요?"]

    question_list = []
    for i in range(1, 6):
        if i == 1:
            question_list.append(random.choice(Q1))
        elif i == 2:
            question_list.append(random.choice(Q2))
        elif i == 3:
            question_list.append(random.choice(Q3))
        elif i == 4:
            question_list.append(random.choice(Q4))
        elif i == 5:
            question_list.append(random.choice(Q5))
